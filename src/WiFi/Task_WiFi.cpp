...
void networkConnector(void) {
  xTaskCreatePinnedToCore(beginWiFiTask, "beginWiFiTask", 4096, NULL, 2, &ntConnectTaskHandler,0);
}

void networkScanner(void) {
  xTaskCreatePinnedToCore(scanWiFiTask, "scanWiFiTask", 4096, NULL, 1, &ntScanTaskHandler,0);
}
